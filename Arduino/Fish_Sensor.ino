...
protected:
    ...
    void loop() {
          ...
          Firebase.setFloat("/ID/Fish/WaterQuality/Temp/", temp);
          Firebase.setFloat("/ID/Fish/WaterQuality/Turbidity/", turbidity);
          Firebase.setFloat("/ID/Fish/WaterQuality/pH/", pH);
    }
private:
    uint8_t state;
} quality_task;
...
protected:
    ...
    void loop()  {
      ...
      if( waterlevel == 0 )
      {
        Firebase.setString("/ID/Fish/Tank/WaterLevel/","Low Level");
      }
      else if ( waterlevel == 1 )
      {
        Firebase.setString("/ID/Fish/Tank/WaterLevel/","Normal");
      }
      else if ( waterlevel == 2 )
      {
        Firebase.setString("/ID/Fish/Tank/WaterLevel/","Abnormal");
      }
      else if ( waterlevel == 3 )
      {
        Firebase.setString("/ID/Fish/Tank/WaterLevel/","Dangerous");
      }
    }
} waterlevel_task;
